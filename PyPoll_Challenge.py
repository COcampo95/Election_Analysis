...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (all_votes > largest_county_count) and (all_votes_percentage > largest_county_percentage):
          largest_county_turnout = county_name
          largest_county_percentage = all_votes_percentage
          largest_county_count = all_votes
